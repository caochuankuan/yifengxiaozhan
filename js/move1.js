class Firework {
    ...
    init() {
        ...
        this.firebox.style.cssText = `width:5px;height:5px;background:#fff;position: fixed;left:${this.x}px;top:${this.ch}px;`;
    ...
    createfires() {
        for (let i = 1; i <= this.rannum(30, 60); i++) {
            ...
            this.fires.style.cssText = `width:5px;height:5px;background:rgb(${this.rannum(0, 255)},${this.rannum(0, 255)},${this.rannum(0, 255)});position: fixed;left:${this.x}px;top:${this.y}px;`;
